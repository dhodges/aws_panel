(ns aws-panel.notifiers.core
  (:require [clojure.tools.logging :as log]
            [aws-panel.routes.websockets :as ws]
            [aws-panel.notifiers.ec2 :as ec2]
            [aws-panel.notifiers.rds :as rds]
            [aws-panel.notifiers.route53 :as route53]
            [aws-panel.notifiers.cloudformation :as cloudform]
...
(defn stop
  []
  (log/info "stopping aws-panel.notifiers")
  (pause))
